                                ...
                                <table class=" border-0 table-hover mx-auto ">
                                        ...
                                        <tbody>
                                            <?php if($spec["short_name"]=="CP"){?>
                                                <tr>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=CP-1&semestre=S1-CP">1ère année</a></td>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=CP-1&semestre=S2-CP">1ère année</a></td>

                                                </tr>
                                                <tr>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=CP-2&semestre=S3-CP">2ème année</a></td>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=CP-2&semestre=S4-CP">2ème année</a></td>

                                                </tr>

                                            <?php }else{?>
                                                <tr>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=<?php echo $spec["short_name"];?>-1&semestre=S1-CI">1ère année</a></td>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=<?php echo $spec["short_name"];?>-1&semestre=S2-CI">1ère année</a></td>

                                                </tr>
                                                <tr>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=<?php echo $spec["short_name"];?>-2&semestre=S3-CI">2ème année</a></td>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=<?php echo $spec["short_name"];?>-2&semestre=S4-CI">2ème année</a></td>

                                                </tr>
                                                <tr>
                                                    <td><a href="index.php?action=show_view_schedule_for_admin_exam&classe=<?php echo $spec["short_name"];?>-3&semestre=S5-CI">3ème année</a></td>
                                                    <td></td>
