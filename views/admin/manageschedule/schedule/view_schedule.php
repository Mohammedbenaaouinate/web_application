            ...
            <script>
                function Delete_schedule($name,$semester){
                    ...
                    if(confirm("Etes vous sur de vouloir vider ce emploi pour cette classe ?")){
                        window.location.href='index.php?action=delete_schedule_for_admin&classe='+$name+'&semestre='+$semester;
                    }
                }
            </script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                cells.forEach(cell => {
                    cell.addEventListener('click', function() {
                       ...
                       window.location.href="index.php?action=show_add_schedule_for_admin&day="+day+"&hour="+hour+"&semestre="+semestre+"&classe="+classe;
                    });
                });
            });
        </script>
