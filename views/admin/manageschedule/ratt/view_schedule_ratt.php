    ...
    <script>
        function Delete_ratt($name,$semester){
            ...
            if(confirm("Etes vous sur de vouloir vider ce emploi pour cette classe ?")){
                window.location.href='index.php?action=delete_schedule_ratt_for_admin&classe='+$name+'&semestre='+$semester;
            }
        }
    </script>
        </div>
        ...
        cells.forEach(cell => {
            cell.addEventListener('click', function() {
                ...
                if (professeur) {
                    ...
                    window.location.href = `index.php?action=show_view_schedule_for_admin_ratt&classe=${classe}&semestre=${semestre}`;

                } else {
                    window.location.href = `index.php?action=show_add_schedule_ratt_for_admin&day=${day}&hour=${hour}&semestre=${semestre}&classe=${classe}`;
                }
            });
        });
    });
