    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=add_class" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Ajouter une classe</span></h5>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" name="classe">
                                            ...
                                            <?php foreach ($field as $result) { ?>
                                                <option><?= $result["short_name"]; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        <label>Année de la classe<span class="login-danger">*</span></label>
                                        <select class="form-control select" name="annee">
                                            <option>Séléctionner Niveau de la classe</option>
