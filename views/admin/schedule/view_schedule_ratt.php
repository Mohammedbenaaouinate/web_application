                ...
                <li>
                    ...
                    <li class="submenu active">
                        ...
                        <ul>
                            ...
                            <li><a href="index.php?action=schedule_ratt_admin" class="active">Liste des emplois ds Rattrapage</a></li>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=schedule_ratt_admin">Listes des emplois</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="printArea">
                            ...
                            <div class="form-group row">
                                <h4 class="emploi">EMPLOI DES EXAMENS (SESSION RATTRAPAGE) </h4>
                                <?php
                                        ...
                                        <tr>
                                            ...
                                            <?php for ($j = 0; $j < 4; $j++) { ?>
                                                <td style="width:250px">
                                                    <?php
                                                    foreach ($view_schedule_ratt as $view) { ?>
