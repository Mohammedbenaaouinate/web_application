        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php?action=schedule_ratt_admin">Liste des emplois</a></li>
                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Listes des Emplois (SESSION RATTRAPAGE)</h3>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($list_schedule_ratt as $result) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="index.php?action=view_schedule_admin_ratt&id=<?php echo $result["classe"]; ?>&sem=<?php echo $result["semester_name"]; ?>" class="btn btn-sm bg-success-light me-2">
