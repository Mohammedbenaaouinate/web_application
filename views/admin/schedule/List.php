                ...
                <div class="card card-table">
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Listes des Emplois</h3>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($list_schedule as $result) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="index.php?action=view_schedule_admin&id=<?php echo $result["classe"]; ?>&sem=<?php echo $result["semester_name"]; ?>" class="btn btn-sm bg-success-light me-2">
