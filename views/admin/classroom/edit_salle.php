    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Modifier Salle</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php?action=salle">Salle</a></li>
                        <li class="breadcrumb-item active">Modifier Salle</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=edit_salle" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Modifier une Salle</span></h5>
                                </div>
                                <input type="hidden" name="id" value="<?= $salle["classroom_id"]; ?>">
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Nom de la salle <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="name_salle" value="<?= $salle["classroom_name"]; ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Capacité</label>
                                        <input type="number" name="capacity" class="form-control" value="<?= $salle["classroom_capacity"]; ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Bloc <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="bloc" value="<?= $salle["bloc"]; ?>">
                                    </div>
                                </div>
