        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu active">
                    ...
                    <ul>
                        <a href="index.php?action=salle" class="active"> <span>Gestion des salles</span></a>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php?action=salle">Salle</a></li>
                        <li class="breadcrumb-item active">Tous les Salles</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="index.php?action=show_add_salle" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($list_salle as $result) { ?>
                                        <tr>
                                            <td>
                                                <h2>
                                                    <a><?php echo $result["classroom_name"]; ?></a>
                                                </h2>
                                            </td>
                                            <td><?php echo $result["classroom_capacity"]; ?></td>
                                            <td><?php echo $result["bloc"]; ?></td>
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="index.php?action=show_edit_salle&id=<?php echo $result["classroom_id"]; ?>" class="btn btn-sm bg-success-light me-2">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a onclick="confirmDelete(<?php echo $result['classroom_id']; ?>)" href="#" class="btn btn-sm bg-danger-light">
                            ...
                            <script>
                                function confirmDelete(id) {
                                    if (confirm("Êtes-vous sûr de vouloir supprimer cette Salle ?")) {
                                        window.location.href = 'index.php?action=delete_salle&id=' + id;
                                    }
                                }
                            </script>
                        </div>
