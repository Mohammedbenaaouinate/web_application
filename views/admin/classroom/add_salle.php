    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Ajouter Salle</h3>
                    <ul class="breadcrumb">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=add_salle" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Ajouter une Salle</span></h5>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Nom de la salle <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="name_salle">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Bloc <span class="login-danger">*</span></label>
