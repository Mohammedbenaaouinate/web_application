<?php
$title = "Students | Filter old_lauréat";
ob_start();
?>
            ...
            <ul>
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li><a href="index.php?action=old_year_winner" class="active"><i class="fas fa-graduation-cap"></i> <span>Les anciens lauréats</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Liste des anciens lauréats</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="student-group-form">
            <form action="index.php?action=filter_old_laureat" method="post">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6">
                        <div class="form-group local-forms">
                            <select class="form-control select" name="year" required>
                                <option value="">L'année de graduation</option>
                                <?php
                                foreach ($years as $year) {
                                    if ($year['school_year'] == $selected_year) {
                                        echo '<option value="' . $year['school_year'] . '" selected>' . $year['school_year'] . "</option>";
                                    } else {
                                        echo '<option value="' . $year['school_year'] . '">' . $year['school_year'] . "</option>";
                                    }
                                }
                                ?>
                            </select>
