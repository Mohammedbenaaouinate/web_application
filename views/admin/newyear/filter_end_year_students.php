<?php
$title = "student | filter_end_year_student";
ob_start();
?>
                ...
                <div class="card card-table comman-shadow">
                    <div class="card-body">
                        <div class="table-responsive">
                            <form action="index.php?action=archiver_adm_students" method="post">
                                    ...
                                    <tbody>
                                        <?php foreach ($students as $student) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <input type="checkbox" name="ADM[]" value="<?= $student['student_id']; ?>">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex justify-content-center align-items-center">
                                                        <input type="checkbox" name="NOADM[]" value="<?= $student['student_id']; ?>">
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center p-4">
                                    ...
                                    <a href="index.php?action=end_year_student" class="btn btn-danger btn-lg" style="width: 45%;"><span class="me-3"><i class="fa fa-times"></i></span> Annuler</a>
                                </div>
                            </form>
                        </div>
                    </div>
