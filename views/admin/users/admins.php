      ...
      <ul>
        ...
        <li class="submenu active">
          ...
          <ul>
            ...
            <li><a href="index.php?action=admins" class="active">Administrateur</a></li>
          ...
          <div class="page-sub-header">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="index.php?action=admins">Administrateur</a>
              </li>
              <li class="breadcrumb-item active">Tous Administrateurs</li>
            </ul>
          </div>
        </div>
      </div>
                    ...
                    <tr>
                      <td>
                        <h2 class="table-avatar">
                          <a href="#" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="<?= "assets/admins/" . $admin['image_path']; ?>" alt="User Image" /></a>
                          <a href="#"><?= $admin['lastname']; ?></a>
                        </h2>
                      </td>
                      ...
                      <td><?= $admin['short_name']; ?></td>
                      <td class="text-end">
                        <div class="actions">
                          <form action="index.php?action=delete-admin-action" method="post">
                            <input type="hidden" name="admin_id" value="<?= $admin['prof_id']; ?>">
                            <button type="submit" class="btn btn-sm bg-success-light me-2 delete_edit_hover delete_button_admin" data-firstname="<?= $admin['firstname']; ?>" data-lastname="<?= $admin['lastname']; ?>"><i class="feather-trash"></i></button>
                          </form>
                          <form action="index.php?action=edit-admin-teacher" method="post">
                            <input type="hidden" name="admin_teacher_id" value="<?= $admin['prof_id']; ?>">
