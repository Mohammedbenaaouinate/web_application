    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card comman-shadow">
          <div class="card-body">
            <form action="index.php?action=update-student-action" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-12">
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <input class="form-control" type="text" placeholder="Saisir Le Prenom" name="firstname" value="<?= $student_information['firstname']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Nom <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir le Nom" name="lastname" value="<?= $student_information['lastname']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Massar <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir Massar" name="massar_student" value="<?= $student_information['massar_student']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>code apogée <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir Apogée de l'étudiant" name="student_apoge" value="<?= $student_information['student_apoge']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>CIN <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir CIN" name="cin_student" value="<?= $student_information['cin_student']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Nationnalité</label>
                    <input class="form-control" type="text" placeholder="Saisir la Nationnalité" name="nationality" value="<?= $student_information['nationality']; ?>" />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>mot de passe <span class="login-danger">*</span></label>
                    <input class="form-control" type="password" placeholder="Saisir le mot de passe" name="password"/>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Numéro de Téléphone</label>
                    <input class="form-control" type="tel" placeholder="0612131415" name="phone_number" pattern="[0-9]{10}" value="<?= $student_information['phone_number']; ?>" />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <select class="form-control select" name="sexe">
                      <?php
                      if ($student_information['sexe'] == " ") {
                        echo '<option value="" selected> Sélectionnez le sexe</option>';
                      } else {
                        echo "<option value=''>Sélectionnez le sexe</option>";
                      }
                      if ($student_information['sexe'] == "Femme") {
                        echo "<option value='Femme' selected>Femme</option>";
                      } else {
                        echo "<option value='Femme'>Femme</option>";
                      }
                      if ($student_information['sexe'] == "Homme") {
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Adresse</label>
                    <input class="form-control" type="text" placeholder="Saisir l'adresse" name="student_adress" value="<?= $student_information['student_adress']; ?>" />
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms calendar-icon">
                    ...
                    <input class="form-control datetimepicker" name="birth_date" value="<?= $student_information['birth_date']; ?>" type="text" placeholder="DD-MM-YYYY" required>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <select class="form-control select" name="class_id" data-live-search="true" required="required">
                      ...
                      <?php foreach ($allclasses as $class) {
                        if ($class['class_id'] == $student_information['class_id']) {
                ...
                <div class="col-lg-6 col-sm-6">
                  <div class="form-group local-forms">
                    <?php
                    $exploded = explode("@", $student_information['email']);
                    $email_exploded = $exploded[0];

                    ?>
                    <label>Email <span class="login-danger">*</span></label>
                    <div class="col-lg-10">
                      <div class="input-group">
                        <input type="text" class="form-control" placeholder="Saisir mail Académique" name="email" value="<?= $email_exploded; ?>" required />
                ...
                <div class="col-lg-6 col-sm-6">
                  <input type="hidden" name="old_image_path" value="<?= $student_information['image_path'] ?>">
                </div>
                <div class="col-lg-6 col-sm-6">
                  <input type="hidden" name="student_id" value="<?= $student_information['student_id'] ?>">
                </div>
                <div class="col-12">
