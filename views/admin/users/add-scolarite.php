  ...
  <div class="content container-fluid">
    <div class="page-header">
      <div class="row d-flex align-items-center justify-content-center ">
        <div class="d-flex justify-content-center align-items-center">
          <h5 class="page-title">Ajout d'un membre de la scolarité</h5>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-body">
            <form action="index.php?action=add-scolarite-action" method="post" enctype="multipart/form-data">
              <div class="row">
