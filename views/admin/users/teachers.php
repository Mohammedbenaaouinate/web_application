      ...
      <ul>
        ...
        <li class="submenu active">
          ...
          <ul>
            ...
            <li><a href="index.php?action=teachers" class="active">Professeur</a></li>
          ...
          <div class="page-sub-header">
            ...
            <ul class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="index.php?action=teachers">Professeur</a>
              </li>
              <li class="breadcrumb-item active">Tous Professeur</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="page-header">
              <div class="row align-items-center">
                ...
                <div class="col-auto text-end float-end ms-auto download-grp">
                  <a href="index.php?action=add-teacher-admin" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                </div>
              </div>
            </div>
                    ...
                    <tr>
                      <td>
                        <h2 class="table-avatar">
                          <a href="#" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="<?= "assets/teachers/" . $teacher['image_path']; ?>" alt="User Image" /></a>
                          <a href="#"><?= $teacher['lastname']; ?></a>
                        </h2>
                      </td>
                      <td><?= $teacher['firstname']; ?></td>
                      <td><a href="mailto:<?= $teacher['email']; ?>" style="color:#2e86de; font-weight:bold;"><u><?= $teacher['email']; ?></u></a></td>
                      ...
                      <td class="text-end">
                        <div class="actions">
                          <form action="index.php?action=delete-teacher-action" method="post">
                            <input type="hidden" name="teacher_id" value="<?= $teacher['prof_id']; ?>">
                            <button type="submit" class="btn btn-sm bg-success-light me-2 delete_edit_hover delete_button_teacher" data-firstname="<?= $teacher['firstname']; ?>" data-lastname="<?= $teacher['lastname']; ?>"><i class="feather-trash"></i></button>
                          </form>
                          <form action="index.php?action=edit-admin-teacher" method="post">
                            <input type="hidden" name="admin_teacher_id" value="<?= $teacher['prof_id']; ?>">
