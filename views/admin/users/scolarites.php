      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="page-sub-header">
            <h3 class="page-title">Scolarité</h3>
            <ul class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="index.php?action=scolarite">Scolarité</a>
              </li>
            ...
            <div class="page-header">
              <div class="row align-items-center">
                ...
                <div class="col-auto text-end float-end ms-auto download-grp">
                  <a href="index.php?action=add-scolarite" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                </div>
              </div>
            </div>
                    ...
                    <tr>
                      <td>
                        <h2 class="table-avatar">
                          <a href="#" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="<?= "assets/scolarites/" . $scolarite['image_path']; ?>" alt="User Image" /></a>
                          <a href="#"><?= $scolarite['lastname']; ?></a>
                        </h2>
                      </td>
                      <td> <?= $scolarite['firstname']; ?></td>
                      <td><a href="mailto:<?= $scolarite['email']; ?>" style="color:#2e86de; font-weight:bold;"><u><?= $scolarite['email']; ?></u></a></td>
                      <td><?= $scolarite['phone_number']; ?></td>
                      <td class="text-end">
                        <div class="actions">
                          <form action="index.php?action=delete-scolarite-action" method="post">
                            <input type="hidden" name="scolarite_id" value="<?= $scolarite['employee_id']; ?>">
                            <button type="submit" class="btn btn-sm bg-success-light me-2 delete_edit_hover delete_button_scolarite" data-firstname="<?= $scolarite['firstname']; ?>" data-lastname="<?= $scolarite['lastname']; ?>"><i class="feather-trash"></i></button>
                          </form>
                          <form action="index.php?action=edit-scolarite" method="post">
                            <input type="hidden" name="scolarite_id" value="<?= $scolarite['employee_id']; ?>">
