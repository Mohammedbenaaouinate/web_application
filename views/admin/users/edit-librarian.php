<?php
$title = "librarian | edit-librairian";
ob_start();
?>
  ...
  <div class="content container-fluid">
    <div class="page-header">
      <div class="row d-flex align-items-center justify-content-center ">
        <div class="d-flex justify-content-center align-items-center">
          <h5 class="page-title">Modifier: Bibliothécaire</h5>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-body">
            <form action="index.php?action=update-librarian-action" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Prenom <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir Le Prenom" name="firstname" value="<?= $librarian['firstname']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Nom <span class="login-danger">*</span></label>
                    <input class="form-control" type="text" placeholder="Saisir le Nom" name="lastname" value="<?= $librarian['lastname']; ?>" required />
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    <label>Numéro de Téléphone <span class="login-danger">*</span></label>
                    <input class="form-control" type="tel" placeholder="0612131415" name="phone_number" value="<?= $librarian['phone_number']; ?>" pattern="[0-9]{10}" required />
                  </div>
                </div>
                ...
                <div class="col-12 col-sm-4">
                  <input type="hidden" class="form-control" name="employee_id" value="<?= $librarian['employee_id']; ?>" required />
                </div>
                <div class="col-12 col-sm-4">
                  <input type="hidden" class="form-control" name="old_image_path" value="<?= $librarian['image_path']; ?>" required />
                </div>
                <div class="col-12">
