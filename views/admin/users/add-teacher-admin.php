<?php
$title = "teachers | add teacher-admin";
ob_start();
?>
  ...
  <div class="content container-fluid">
    <div class="page-header">
      <div class="row align-items-center">
        <div class="col">
          <h3 class="page-title">Ajouter : Administrateur--professeur</h3>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-body">
            <form action="index.php?action=add-teacher-admin-action" method="post" enctype="multipart/form-data">
              <div class="row">
                  ...
                  <div class="form-group local-forms">
                    ...
                    <select class="form-control select" name="departement_id" required="required">
                      ...
                      <?php foreach ($departements as $departement) { ?>
                        <option value="<?= $departement['departement_id']; ?>"><?= $departement['short_name']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
