<?php
$title = "Users | add head_of_school";
ob_start();
?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div>
                    <h3 class="page-title text-center" style="font-style: italic;font-family: math;"><u>Ajouter : Directeur </u></h3>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=add_head_of_school_action" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="text" placeholder="Saisir la Spécialité" name="specialite" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="tel" placeholder="0612131415" name="phone_number" pattern="[0-9]{10}" required />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group students-up-files">
                                        ...
                                        <div class="uplod">
                                            <label class="file-upload image-upbtn mb-0">
                                                choisir l'image<input type="file" name="image_path" accept="image/*" />
                                            </label>
                                        </div>
                                    </div>
                                </div>
