    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=update-subject-action" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" name="modul_code" value="<?= $subjectInformation['modul_code']; ?>" required />
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" name="modul_name" value="<?= $subjectInformation['modul_name']; ?>" required />
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="search-by-name form-control select" name="prof_id" required>
                                            ...
                                            foreach ($professeurs as $professeur) {
                                                echo '<option value="' . $professeur['prof_id'] . '"' . ($professeur['prof_id'] == $subjectInformation['prof_id'] ? " selected" : "") . ">" . $professeur['firstname'] . "  " . $professeur['lastname'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" name="intervenant" value="<?= $subjectInformation['intervenant']; ?>" required />
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Email Intervenant: <span class="login-danger">*</span></label>
                                        <input type="email" class="form-control" name="intervenant_email" value="<?= $subjectInformation['intervenant_email']; ?>" required />
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" name="field_id" id="select_sepecialization" required="required">
                                            ...
                                            foreach ($specializations as $specialization) {
                                                echo '<option value="' . $specialization['specialization_id'] . '"' . ($specialization['specialization_id'] == $subjectInformation['specialization_id'] ? " selected" : "") . ">" . $specialization['short_name'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" name="class_id" id="select_class" required>
                                            ...
                                            foreach ($classes as $classe) {
                                                echo '<option value="' . $classe['class_id'] . '"' . ($classe['class_id'] == $subjectInformation['class_id'] ? " selected" : "") . ">" . $classe['class_name'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select" name="semester_id" required>
                                            ...
                                            foreach ($semesters as $semester) {
                                                echo '<option value="' . $semester['semester_id'] . '"' . ($semester['semester_id'] == $subjectInformation['semester_id'] ? " selected" : "") . ">" . $semester['semester_name'] . "</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <input type="hidden" class="form-control" name="modul_id" value="<?= $modul_id; ?>" required />
                                    </div>
                                </div>
                                <div class="col-12">
