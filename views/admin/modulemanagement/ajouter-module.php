<?php
$title = "Module | Ajouter Module-Element";
ob_start();
?>
  ...
  <div class="content container-fluid">
      ...
      <div class="row align-items-center">
        <div class="col">
          ...
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Ajouter un Module pour les éléments </li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-body">
            <form action="index.php?action=ajouter-module-action" method="post">
              <div class="row">
                <div class="col-12">
                  <h5 class="form-title">
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <input type="text" class="form-control" name="module_code" required />
                  </div>
                </div>
