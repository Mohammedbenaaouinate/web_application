                    ...
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="index.php?action=cv_list">Etudiant</a>
                            </li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                <p class="text-center" style="font-family:'Times New Roman' ;font-weight:bold;"> Les étudiants de la classe <?= $class_name; ?></p>
