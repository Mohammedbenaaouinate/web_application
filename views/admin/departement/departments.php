<?php
$title = "Admin | Liste Departements";
            ...
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Liste Departement</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="index.php?action=show_add_departement" class="btn btn-primary"><i class="fas fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($list as $result) { ?>
                                        <tr>
                                            <td>
                                                <h2>
                                                    <a><?php echo $result["departement_name"]; ?></a>
                                                </h2>
                                            </td>
                                            <td style="text-transform: uppercase;"><?php echo $result["short_name"]; ?></td>
                                            <td><?php echo $result["firstname"] . " " . $result["lastname"]; ?></td>
                                            <td><a href="mailto:<?php echo $result["email"] ?>" style="color:#2e86de; font-weight:bold;"><?php echo $result["email"] ?>
                                                </a>
                                            </td>
                                            <td><?php echo $result["phone_number"] ?></td>
                                            <td>
                                                <div style="width:400px;overflow-y:hidden; overflow-x:scroll;"><?php echo $result["description"]; ?></div>
                                            </td>
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a href="index.php?action=show_edit_departement&id=<?php echo $result["departement_id"]; ?>" class="btn btn-sm bg-success-light me-2">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a onclick="confirmDelete(<?php echo $result['departement_id']; ?>)" href="#" class="btn btn-sm bg-danger-light">
                        ...
                        <script>
                            function confirmDelete(id) {
                                if (confirm("Êtes-vous sûr de vouloir supprimer cet Département ?")) {
                                    window.location.href = 'index.php?action=delete_departement&id=' + id;
                                }
                            }
                        </script>
                    </div>
