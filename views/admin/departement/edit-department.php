<?php
$title = "Admin | Editer Departement";
ob_start();
?>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php?action=departement">Departement</a></li>
                        <li class="breadcrumb-item active">Modifier Departement</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form action="index.php?action=edit_department" method="post">
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Modifier les informations de Departement</span></h5>
                                </div>
                                <input type="hidden" value="<?php echo $dep['departement_id'] ?>" name="id">
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Nom de Departement <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" value="<?php echo $dep['departement_name'] ?>" name="departement_name">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Acronyme de Departement <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="short_name" style="text-transform: uppercase;" value="<?php echo $dep['short_name'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label>Chef de Departement <span class="login-danger">*</span></label>
                                        <select id="example-select" class="form-control form-select" name="departement_leader">
                                            <?php foreach ($all_dep as $res) {
                                                if ($dep["departement_leader"] != "") {

                                                    if ($res["prof_id"] == $dep["departement_leader"]) { ?>
                                                        <option selected value="<?php echo $res["prof_id"] ?>"><?php echo $res['firstname'] . " " . $res['lastname']; ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $res["prof_id"] ?>"><?php echo $res['firstname'] . " " . $res['lastname']; ?></option>
                                                    <?php } ?>
                                                <?php } else { ?>
                                                    <option value="<?php echo $res["prof_id"] ?>"><?php echo $res['firstname'] . " " . $res['lastname']; ?></option>
                                                <?php } ?>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="text" value="<?php echo $dep['description'] ?>" name="description">
                                    </div>
                                </div>
