<?php
$title = "Specialization | Edit Specialization";
ob_start();
?>
...
<div class="page-wrapper">
        ...
        <div class="col">
          ...
          <ul class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="index.php?action=specializations">Filière</a>
            </li>
            <li class="breadcrumb-item active">Modifier Filière</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Filière</h5>
          </div>
          <div class="card-body">
            <form action="index.php?action=update-specialization-action" method="post">
              <div class="form-group row">
                <label class="col-form-label col-md-2">Label <span class="login-danger">*</span></label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Exemple:GTR" name="short_name" value="<?= $specialization['short_name']; ?>" required />
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-md-2">Nom <span class="login-danger">*</span></label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Exemple:Génie des Télécommunications et Réseaux" name="fullname" value="<?= $specialization['fullname']; ?>" required />
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-md-2">Département<span class="login-danger"> *</span></label>
                <div class="col-md-10">
                  <select class="form-control form-select" name="departement_id" id="select_departement" required>
                    <option value="">Sélectionnez le Département</option>
                    <?php
                    foreach ($departements as $departement) {
                      echo '<option value="' . $departement['departement_id'] . '"' . ($departement['departement_id'] == $specialization['departement_id'] ? " selected" : "") . '>' . $departement['departement_name'] . "</option>";
                    }
                    ?>
                  </select>
                </div>
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-2">Coordonnateur <span class="login-danger"> *</span></label>
                <div class="col-md-10">
                  <select class="search-by-name form-control form-select" name="coordonnateur_id" id="select_coordonnateur" required>
                    <option value="">Sélectionnez le professeur</option>
                    <?php
                    foreach ($proffesseurs as $proffesseur)
                      echo '<option value="' . $proffesseur['prof_id'] . '"' . ($proffesseur['prof_id'] == $specialization['coordonnateur_id'] ? " selected" : "") . '>' . $proffesseur['firstname'] . "  " . $proffesseur['lastname'] . "</option>";
              ...
              <div class="form-group row">
                <label class="col-form-label col-md-2">Description<span class="login-danger"> *</span></label>
                <div class="col-md-10">
                  <textarea rows="5" cols="5" class="form-control" name="description_field" required><?= $specialization['description_field']; ?></textarea>
                </div>
              </div>
              <div class="col-12">
                <input type="hidden" class="form-control" name="specialization_id" value="<?= $specialization['specialization_id']; ?>" required />
              </div>
              <div class="col-12">
                <input type="hidden" class="form-control" name="previous_coord_id" value="<?= $specialization['coordonnateur_id']; ?>" required />
              </div>
              <div class="col-12">
  ...
  <footer>
    <p>
      Copyright © 2024 Ecole Nationale Des Sciences Appliquées El Jadida.
    </p>
  </footer>
</div>
<?php
