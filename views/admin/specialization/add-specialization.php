<?php
$title = "Specialization | Add Specialization";
ob_start();
?>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="index.php?action=add-specialization-action" method="post">
              <div class="form-group row">
                <label class="col-form-label col-md-2">Label <span class="login-danger">*</span></label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Exemple:GTR" name="short_name" required />
                </div>
              </div>
              <div class="form-group row">
                <label class="col-form-label col-md-2">Nom <span class="login-danger">*</span></label>
                <div class="col-md-10">
                  <input type="text" class="form-control" placeholder="Exemple:Génie des Télécommunications et Réseaux" name="fullname" required />
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <select class="form-control form-select" name="departement_id" id="select_departement" required>
                    ...
                    foreach ($departements as $departement) {
                      echo '<option value="' . $departement['departement_id'] . '">' . $departement['departement_name'] . "</option>";
                    }
                    ?>
                  </select>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <select class="search-by-name form-control form-select" name="coordonnateur_id" id="select_coordonnateur" style="width: 100%;" required>
                    <option value="">Sélectionnez le Département</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea rows="5" cols="5" class="form-control" name="description_field" required></textarea>
                </div>
              </div>
              <div class="col-12">
