<?php
$title = "Scolarité | Demandes de Relevé de notes";
ob_start();
            ...
            <ul>
                ...
                <li class="submenu active">
                    ...
                    <ul>
                        ...
                        <li><a href="index.php?action=all_marks_requests" class="active">Relvé de notes</a></li>
                    </ul>
                </li>
                <li>
                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Relvé de notes</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php foreach ($requests as $request) { ?>
                                        ...
                                        <div id="modal-service-<?= $request['service_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="index.php?action=refuse_mark_request" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <form action="index.php?action=accept-mark-request" method="post">
                                                        <input type="hidden" name="service_id" value="<?= $request['service_id']; ?>">
                                                        <button type="submit" class="btn btn-sm  text-white" style="background-color: #1e90ff;font-weight:bold;"><i class="feather-check"></i></button>
                                                    </form>
                                                    <button type="button" style="font-weight:bold;" class="btn btn-sm bg-danger ms-2 text-white" data-bs-toggle="modal" data-bs-target="#modal-service-<?= $request['service_id']; ?>"><i class="fa fa-times"></i></button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
