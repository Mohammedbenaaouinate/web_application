<?php
$title = "Scolarité | Attestion de Scolarité";
ob_start();
                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Attestation de Scolarité</li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php foreach ($requests as $request) { ?>
                                        ...
                                        <div id="modal-service-<?= $request['service_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form action="index.php?action=delete_school_certificate" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="#" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="assets/students/<?= $request['image_path']; ?>" onerror="this.onerror=null;this.src='assets/students/default_image.jpg'" alt="" /></a>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <form action="index.php?action=view-student-certificate" method="post">
