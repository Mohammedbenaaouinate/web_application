<?php
$title = "Chef Département | Emploi des DS";
ob_start();
?>
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu active">
                        ...
                        <ul>
                            <li class="active"><a href="index.php?action=schedule_exam">Session normale</a></li>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=schedule_exam">Session normale</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <?php foreach ($list_specialisation as $spec) { ?>
                                ...
                                <table class=" border-0 table-hover mx-auto ">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="index.php?action=schedule_table_normal&classe=<?php echo $spec["short_name"]; ?>-1&semestre=S1-CI">1ère année</a></td>
                                            <td><a href="index.php?action=schedule_table_normal&classe=<?php echo $spec["short_name"]; ?>-1&semestre=S2-CI">1ère année</a></td>

                                        </tr>
                                        <tr>
                                            <td><a href="index.php?action=schedule_table_normal&classe=<?php echo $spec["short_name"]; ?>-2&semestre=S3-CI">2ème année</a></td>
                                            <td><a href="index.php?action=schedule_table_normal&classe=<?php echo $spec["short_name"]; ?>-2&semestre=S4-CI">2ème année</a></td>

                                        </tr>
                                        <tr>
                                            <td><a href="index.php?action=schedule_table_normal&classe=<?php echo $spec["short_name"]; ?>-3&semestre=S5-CI">3ème année</a></td>
                                            <td></td>
