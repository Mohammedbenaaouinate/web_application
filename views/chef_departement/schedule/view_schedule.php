    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        <h3 class="page-title">Gestion des Emploie</h3>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body" id="printArea">
                            ...
                            <a onclick="Delete_schedule('<?= $class_name; ?>','<?= $semester; ?>')" style="width:100%" class="btn btn-danger mt-4 no-print"><i class="fas fa-trash" style="margin-right:10px;"></i>Vider Ce emploi</a>
            ...
            <script>
                function Delete_schedule($name, $semester) {

                    if (confirm("Etes vous sur de vouloir vider ce emploi pour cette classe ?")) {
                        window.location.href = 'index.php?action=delete_schedule&classe=' + $name + '&semestre=' + $semester;
                    }
                }
            </script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            cells.forEach(cell => {
                cell.addEventListener('click', function() {
                    ...
                    window.location.href = "index.php?action=show_add_schedule&day=" + day + "&hour=" + hour + "&semestre=" + semestre + "&classe=" + classe;
                });
            });
        });
    </script>
