            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=user_emploi_ratt">Vos emplois</a></li>
                            ...
                            <table class=" border-0 table-hover mx-auto">
                                ...
                                <tbody>
                                    <?php foreach ($list_shown as $list) { ?>
                                        ...
                                        <tr>
                                            <td><a href="index.php?action=show_my_schedule_ratt&classe=<?= $list["class_name"] ?>&semestre=<?= $list["semester_name"] ?>"><?= $list["class_name"] . " <b>|</b> " . $list["semester_name"] ?></a></td>
