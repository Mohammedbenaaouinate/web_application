<?php
$title = "Chef Département | Filtrer la Liste des étudiants";
ob_start();
?>
<style>
    table {
...
<div class="page-wrapper">
    <div class="content container-fluid">
                ...
                <table class="table" id="student_list">
                    <thead>
                        <tr style="background-color: rgb(237, 208, 165);">
                            <th colspan="7" class="text-center">classe: <?= $classe_name; ?></th>
                        </tr>
        ...
        <div class="d-flex justify-content-center align-items-center mb-3 mt-3">
            <button type="submit" class="btn btn-primary btn-lg" style="width: 50%;" id="print_button_head"> <span class="me-3"><i class="fa fa-print"></i></span>Imprimer</button>
        </div>
    </div>
    <footer class="mt-3">
