    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-md-end">
                <a href="index.php?action=show_add_cour" class="btn btn-primary btn-blog mb-3"><i class="feather-plus-circle me-1"></i> Ajouter Cours</a>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="edit-options">
                                <div class="edit-delete-btn">
                                    <a href="index.php?action=show_edit_course&course_id=<?= $course["id_cour"] ?>" class="text-success"><i class="feather-edit-3 me-1"></i>Editer</a>
        ...
        <script>
            function Delete_course($id) {
                if (confirm("Etes vous sur de vouloir supprimer ce cour?")) {
                    window.location.href = "index.php?action=delete_course&course_id=" + $id
                }
            }
        </script>
    </div>
