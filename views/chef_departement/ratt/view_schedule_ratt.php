                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < 6; $i++) { ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td style="width:250px" data-day="<?php echo htmlspecialchars($days[$i]); ?>" data-hour="<?php echo htmlspecialchars($hours[$j]); ?>" data-semestre="<?php echo htmlspecialchars($semester); ?>" data-classe="<?php echo htmlspecialchars($class_name); ?>" data-prof="<?php echo $data_prof; ?>" data-module="<?php echo $data_module; ?>" data-classroom="<?php echo $data_classroom; ?>">
            ...
            <script>
                function Delete_ratt($name, $semester) {
                    ...
                    if (confirm("Etes vous sur de vouloir vider ce emploi pour cette classe ?")) {
                        window.location.href = 'index.php?action=delete_schedule_ratt&classe=' + $name + '&semestre=' + $semester;
                    }
                }
            </script>
        </div>
            ...
            cells.forEach(cell => {
                cell.addEventListener('click', function() {
                    ...
                    if (professeur) {
                        ...
                        window.location.href = `index.php?action=schedule_table_ratt&classe=${classe}&semestre=${semestre}`;

                    } else {
                        window.location.href = `index.php?action=show_add_schedule_ratt&day=${day}&hour=${hour}&semestre=${semestre}&classe=${classe}`;
                    }
                });
            });
        });
