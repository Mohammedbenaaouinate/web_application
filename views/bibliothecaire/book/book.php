<?php 
$title="Bibliothécaire | Tous les bouquins";
ob_start();
                ...
                <div class="row">
                    <div class="col-md-9">
                        <ul class="list-links mb-4">
                            <li class="active"><a href="index.php?action=show_all_book">Tous les bouquins</a></li>
                            <li><a href="index.php?action=book_available">Bouquin Disponibles</a></li>
                            ...
                            <div class="blog-image">
                                <a href=""><img class="img-fluid image_book" src="assets/bibliothecaires/book/<?= $book["book_image"]; ?>"
                                        ...
                                        <div class="blog-views" style="height:25px;font-size:16px">
                                            <i class="feather-book me-1"></i> <?= $book["quantity"]; ?>
                                        </div>
