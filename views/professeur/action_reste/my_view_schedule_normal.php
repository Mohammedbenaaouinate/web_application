...
<body>
                ...
                <ul>
                    ...
                    <li class="submenu active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="index.php?action=prof_emploi_normal">Emploi de Session normale</a></li>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=prof_emploi_normal">Votre Emploi de temps</a></li>
                        ...
                        <div class="card-body" id="printArea">
                            ...
                            <div class="form-group row">
                                ...
                                if (!empty($name_class["class_year"])) {
                                    ...
                                    if ($tab[1] == 1) {
                                ?>
                                        <p class="classe"><?php echo $tab[1]; ?> <sup>ère</sup> <?php echo $name_class["fullname"]; ?> (<?php echo $semester ?> /<?php echo date("Y") ?>)</p>
                                    <?php } else { ?>
                                        <p class="classe"><?php echo $tab[1]; ?> <sup>ème</sup> <?php echo $name_class["fullname"]; ?> (<?php echo $semester ?> /<?php echo date("Y") ?>)</p>
                                    <?php } ?>
                                <?php } ?>
                            </div>
                                                ...
                                                <td style="width:250px" data-day="<?php echo $days[$i]; ?>" data-hour="<?php echo $hours[$j]; ?>" data-semestre="<?php echo $semester; ?>" data-classe="<?php echo $name_class["class_name"] ?>">
                                                    <?php foreach ($view_schedule as $view) { ?>
                                                        <?php if ($days[$i] == $view["day"] && $view["time"] == $hours[$j]) { ?>
                                                            <?php if (!empty($view["firstname"] . " " . $view["lastname"]) && empty($view["first_prof"]) && empty($view["second_prof"])) { ?>
                                                                <div class="module"><?php echo $view["modul_code"]; ?></div>
                                                                <div class="module"><?php echo $view["firstname"] . " " . $view["lastname"]; ?></div>
                                                                <div>[<?php echo $view["classroom_name"]; ?>]</div>

                                                            <?php } elseif (!empty($view["firstname"] . " " . $view["lastname"]) && !empty($view["first_prof"]) && empty($view["second_prof"])) { ?>
                                                                <div class="module"><?php echo  $view["modul_code"]; ?></div>
                                                                <div class="module"><?php echo $view["firstname"] . " " . $view["lastname"] . "/" . $view["first_prof"]; ?></div>
                                                                <div>[<?php echo $view["classroom_name"]; ?>]</div>

                                                            <?php } elseif (!empty($view["firstname"] . " " . $view["lastname"]) && !empty($view["first_prof"]) && !empty($view["second_prof"])) { ?>
                                                                <div class="module"><?php echo  $view["modul_code"]; ?></div>
                                                                <div class="module"><?php echo $view["firstname"] . " " . $view["lastname"] . "/" . $view["first_prof"] . "/" . $view["second_prof"]; ?></div>
                                                                <div>[<?php echo $view["classroom_name"]; ?>]</div>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    <?php } ?>
    ...
    <script>
        function printDiv(divId) {
            ...
            var popupWin = window.open('', '_blank', 'width=2000,height=600');
