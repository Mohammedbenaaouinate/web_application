            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=prof_emploi_ratt">Vos emplois</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Vos emploi de temps de rattrapage</h5>
                        </div>
                        <div class="card-body">
                            <table class=" border-0 table-hover mx-auto">
                                ...
                                <tbody>
                                    <?php foreach ($list_shown as $list) { ?>
                                        ...
                                        <tr>
                                            <td><a href="index.php?action=show_prof_schedule_ratt&classe=<?= $list["class_name"] ?>&semestre=<?= $list["semester_name"] ?>"><?= $list["class_name"] . " <b>|</b> " . $list["semester_name"] ?></a></td>
