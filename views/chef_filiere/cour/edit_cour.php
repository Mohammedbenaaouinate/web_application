            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.php?action=upload_cour_filiere">Cours</a></li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="index.php?action=edit_cour_filiere" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-12">
