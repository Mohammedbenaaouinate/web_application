            ...
            <ul>
                ...
                <li class="submenu active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="index.php?action=user_emploi_normal_filiere">Emploi de Session normale</a></li>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=user_emploi_normal_filiere">Votre Emploi de temps</a></li>
