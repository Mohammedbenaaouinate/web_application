            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=user_emploi_normal_filiere">Vos emplois</a></li>
                        ...
                        <div class="card-body">
                            <table class=" border-0 table-hover mx-auto">
                                    ...
                                    <?php foreach($list_shown as $list){?>
                                        ...
                                        <tr>
                                            <td><a href="index.php?action=show_my_schedule_normal_filiere&classe=<?= $list["class_name"]?>&semestre=<?= $list["semester_name"]?>"><?= $list["class_name"]." <b>|</b> ".$list["semester_name"]?></a></td>
