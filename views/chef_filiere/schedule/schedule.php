                        ...
                        <div class="card-body">
                            ...
                            <div class="section-title text-center filiere">Filière <?php echo $spec["short_name"];?></div>
                                <table class=" border-0 table-hover mx-auto ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><a href="index.php?action=schedule_table_filiere&classe=<?php echo $spec["short_name"];?>-1&semestre=S1-CI">1ère année</a></td>
                                                <td><a href="index.php?action=schedule_table_filiere&classe=<?php echo $spec["short_name"];?>-1&semestre=S2-CI">1ère année</a></td>

                                            </tr>
                                            <tr>
                                                <td><a href="index.php?action=schedule_table_filiere&classe=<?php echo $spec["short_name"];?>-2&semestre=S3-CI">2ème année</a></td>
                                                <td><a href="index.php?action=schedule_table_filiere&classe=<?php echo $spec["short_name"];?>-2&semestre=S4-CI">2ème année</a></td>

                                            </tr>
                                            <tr>
                                                <td><a href="index.php?action=schedule_table_filiere&classe=<?php echo $spec["short_name"];?>-3&semestre=S5-CI">3ème année</a></td>
                                                <td></td>
