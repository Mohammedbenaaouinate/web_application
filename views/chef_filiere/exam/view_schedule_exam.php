    ...
    <script>
        function Delete_normal($name,$semester){
            ...
            if(confirm("Etes vous sur de vouloir vider ce emploi pour cette classe ?")){
                window.location.href='index.php?action=delete_schedule_normal_filiere&classe='+$name+'&semestre='+$semester;
            }
        }
    </script>
        </div>
        ...
        cells.forEach(cell => {
            cell.addEventListener('click', function() {
                ...
                if (professeur) {
                    ...
                    window.location.href = `index.php?action=schedule_table_normal_filiere&classe=${classe}&semestre=${semestre}`;

                } else {
                    window.location.href = `index.php?action=show_add_schedule_exam_filiere&day=${day}&hour=${hour}&semestre=${semestre}&classe=${classe}`;
                }
            });
        });
    });
