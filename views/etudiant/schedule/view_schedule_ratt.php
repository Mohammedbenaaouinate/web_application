<?php
$title = "Etudiant | SESSION RATTRAPAGE";
ob_start();
?>
                ...
                <ul>
                    ...
                    <li class="submenu active">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="index.php?action=student_planning_ds_ratt">SESSION RATTRAPAGE</a></li>
                        </ul>
                    </li>
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?action=student_planning_ds_ratt">Session rattrapage</a></li>
                            <li class="breadcrumb-item active">Emploi de la Session rattrapage</li>
                        </ul>
                    </div>
                </div>
            </div>
