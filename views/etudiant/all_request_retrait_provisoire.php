<?php
$title = "Etudiant | Retrait Provisoire";
ob_start();
?>
            ...
            <ul>
                ...
                <li class="submenu">
                    ...
                    <ul>
                        ...
                        <li><a href="index.php?action=student_retrait_provisoire" class="active">Retiré Provisoirement</a></li>
                ...
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Retrait Provisoire</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <form action="index.php?action=student_request_retrait_provisoire" method="post">
                                        <button type="submit" class="btn btn-primary" name="btn_retrait_provisoire" id="request_retrait_provisoire"><i class="fas fa-plus"></i> Retrait provisoire</button>
                                    </form>
                                </div>
                            </div>
                        </div>
...
<script>
    var button = document.getElementById("request_retrait_provisoire");
    button.addEventListener("click", function(e) {
        if (!confirm("Souhaitez-vous demander un retrait provisoire de votre diplôme ?")) {
            e.preventDefault();
        }
    });
</script>
