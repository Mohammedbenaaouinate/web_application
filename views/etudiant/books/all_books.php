                            ...
                            <form action="index.php?action=student_request_book" method="post">
                                ...
                                <div class="modal-body">
                                    <div>
                                        ...
                                        <input type="date" class="form-control expiration_date" id="expiration_date" name="expiration_date" placeholder="Choisir la date de retour" required>
                                    </div>
                                    <div>
